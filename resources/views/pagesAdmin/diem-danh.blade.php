			...
			<nav class="navbar navbar-expand-xl w-100">
                <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
                    ...
                    <li class="nav-item"  style="background-color: #AB826B;">
                        <a class="nav-link" href="/pagesAdmin/diem-danh" style="color:white">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<div class="badge rounded-pill text-l bg-success p-2 text-uppercase px-3"><i
													class="bx bxs-circle align-middle me-1"></i>Đã Chấm Công</div>
									...
									<tr>
										...
										<td>
											...
											<div if="value==1"
												class=" value=1 badge rounded-pill text-l bg-success p-2 text-uppercase px-3">
												<i class="bx bxs-circle align-middle me-1"></i>Đã Chấm Công</div>
									...
									<tr>
										...
										<td>Nguyễn Đức Ninh</td>

										<td>

											<div class="badge rounded-pill text bg-danger p-2 text-uppercase px-3"><i
													class="bx bxs-circle align-middle me-1"></i>Chưa Chấm Công</div>
