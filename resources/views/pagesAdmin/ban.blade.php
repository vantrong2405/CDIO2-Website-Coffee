				...
				<nav class="navbar navbar-expand-xl w-100">
					<ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
						...
						<li class="nav-item" style="background-color: #AB826B;">
							<a class="nav-link" href="/pagesAdmin/ban"  style="color:white" >
		...
		<div class="page-wrapper">
			<div class="page-content">
					...
					<div class="col-4 mt-3">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<div class="h4 mt-2 text-secondary text-center">Khu Vực A</div>
									...
									<div class="col-4">
										...
										<div class="card btn">
											...
											<div class="card-body">
												...
												<i class="fa-solid fa-couch"></i> <br>
					...
					<div class="col-4 mt-3">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<div class="h4 mt-2 text-secondary text-center">Khu Vực B</div>
					...
					<div class="col-4 mt-3">
						...
						<div class="card">
							...
							<div class="card-header">
								...
								<div class="h4 mt-2 text-secondary text-center">Khu Vực Trên Lầu</div>
									...
									<div class="col-4">
										...
										<div class="card btn bg-danger">
											...
											<div class="card-body">
												...
												<i style="color: #ffffff;" class="fa-solid fa-couch"></i> <br>

												<b class="text-light">Bàn 1</b>
				...
				<div class="d-flex align-items-center">
					<i class="fa-solid fa-circle ms-3" style="color: #3adf45;"></i> <b class="ms-2 ">Bàn Đã
						Có Khách</b> <br>

					<i class="fa-solid fa-circle ms-3" style="color: #edfc4b;"></i> <b class="ms-2 ">Bàn Đã
						Đặt Trước</b> <br>

					<i class="fa-solid fa-circle ms-3" style="color: #ff3737;"></i> <b class="ms-2 ">Bàn
						Đang Bảo Trì</b>
