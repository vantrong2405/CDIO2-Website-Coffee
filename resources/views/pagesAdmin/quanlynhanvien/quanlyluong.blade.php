					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<h1 class="modal-title fs-5" id="exampleModalLabel">Thêm Mới Nhân Viên</h1><button
									type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
							</div>
							<div class="modal-body">
								<div class="row">
									<div class="row">
										<div class="col-6"><label class="form-label">Tên Nhân Viên</label><input
												type="text" class="form-control mb-3" placeholder="Nhập tên Nhân Viên">
										</div>
										<div class="col-6"><label class="form-label">Lương Cơ Bản</label><input
												type="text" class="form-control mb-3" placeholder="Nhập slug Nhân Viên">
										</div>
									</div>
									<div class="row">
										<div class="col-12"><label class="form-label">Thể Loại</label><select
												class="form-control">
												primary value="1">Fulltime</option>
				...
				<div class="row">
					<div class="card" style="border-bottom: 5px solid  #AB826B;">
						<div class="card-header ">
							<h4 class=" mb-0 text-center align-middle py-2" style="color: #AB826B;"><b>Quản lý lương</b>
							</h4>
						</div>
						<div class="card-body">
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center align-middle text-nowrap"
												style="background-color: #AB826B; color:white;"> Tên Nhân Viên </th>
											<th class="text-center align-middle text-nowrap"
												style="background-color: #AB826B; color:white;"> Lương Cơ Bản </th>
											<th class="text-center align-middle text-nowrap"
												style="background-color: #AB826B; color:white;">Số Ngày Làm</th>
											<th class="text-center align-middle text-nowrap"
												style="background-color: #AB826B; color:white;">Số Ngày Nghỉ</th>
											<th class="text-center align-middle text-nowrap"
												style="background-color: #AB826B; color:white;"> Thể Loại</th>
											<th class="text-center align-middle text-nowrap"
									...
									<tbody>
										<tr>
											...
											<td class="align-middle text-nowrap">3.000.000đ</td>
											...
											<td class="text-center align-middle text-nowrap"><button
													class="btn btn-primary" style="width: 100px;">Fulltime</button></td>
											<td class="text-center align-middle text-nowrap"><button
													class="btn btn-danger" style="width: 100px;">Tạm off</button></td>
											<td class="text-center align-middle text-nowrap"><button
										...
										<tr>
											...
											<td class="align-middle text-nowrap">2.400.000đ</td>
											<td class="align-middle text-nowrap">30</td>
											<td class="align-middle text-nowrap">0</td>
											<td class="text-center align-middle text-nowrap"><button
													class="btn btn-primary" style="width: 100px;">Fulltime</button></td>
										...
										<tr>
											...
											<td class="align-middle text-nowrap">2.900.000đ</td>
										...
										<tr>
											...
											<td class="align-middle text-nowrap">2.999.000đ</td>
											<td class="align-middle text-nowrap">30</td>
											<td class="align-middle">0</td>
											<td class="text-center align-middle text-nowrap"><button
													class="btn btn-primary" style="width: 100px;">Fulltime</button></td>
											<td class="text-center align-middle text-nowrap"><button
													class="btn btn-success" style="width: 100px;">Đang Làm</button></td>
										...
										<div class="modal-body">
											<div class="row">
												...
												<div class="col-12"><label class="form-label mt-3">Lương Cơ Bản
														...
														placeholder="Nhập lương cơ bản"></div>
												<div class="col-12"><label class="form-label mt-3">Thể
														Loại</label><select class="form-control">
														primary value="1">Fulltime</option>
														<option value="0">Fulltime</option>
													</select></div>
												<div class="col-12"><label class="form-label mt-3">Tình
														Trạng</label><select class="form-control">
														<option value="1">Tạm off</option>
